-- =========================================================================
-- OPTIONAL: RESET SCRIPT (Hapus tanda komentar jika ingin mengosongkan DB lokal)
-- =========================================================================

-- DROP TABLE IF EXISTS payments CASCADE;
-- DROP TABLE IF EXISTS order_item_addons CASCADE;
-- DROP TABLE IF EXISTS order_charges CASCADE;
-- DROP TABLE IF EXISTS order_items CASCADE;
-- DROP TABLE IF EXISTS orders CASCADE;
-- DROP TABLE IF EXISTS property_addons CASCADE;
-- DROP TABLE IF EXISTS property_assignments CASCADE;
-- DROP TABLE IF EXISTS facility_assignments CASCADE;
-- DROP TABLE IF EXISTS galleries CASCADE;
-- DROP TABLE IF EXISTS units CASCADE;
-- DROP TABLE IF EXISTS profiles CASCADE;
-- DROP TABLE IF EXISTS master_charges CASCADE;
-- DROP TABLE IF EXISTS master_addons CASCADE;
-- DROP TABLE IF EXISTS master_bank_accounts CASCADE;
-- DROP TABLE IF EXISTS master_properties CASCADE;
-- DROP TABLE IF EXISTS master_organizations CASCADE;
-- DROP TABLE IF EXISTS master_facilities CASCADE;
