// route: host.com/guesthouse/[slug]/[unit]/page.tsx
...
export default async function UnitPage({
  ...
  if (!property || !unit) return notFound();
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#EDE6D6" }}>
      ...
      <section className="max-w-5xl mx-auto px-6 pt-10">
        <p
          ...
          style={{ color: "#B5654A", letterSpacing: "0.12em" }}
        >
          {property.name}
        </p>
        <h1
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        >
          <div>
            <p className="text-sm mb-1" style={{ color: "#6B5D4F" }}>
              Harga per malam
            </p>
            <p className="text-3xl font-semibold" style={{ color: "#1F3B36" }}>
